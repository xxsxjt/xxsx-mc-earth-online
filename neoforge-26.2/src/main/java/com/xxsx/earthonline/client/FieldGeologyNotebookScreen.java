...
public class FieldGeologyNotebookScreen extends Screen {
    ...
    private static List<Page> createPages() {
        ...
        result.add(page("第一天", "2. 第一天路线：第一块铁怎么来？", GOLD,
                ...
                "1. 做石镐和原版熔炉。Earth Online 保留原版熔炉作为新手过渡。",
        ...
        result.add(page("机器", "4. 第一版机器怎么用？", BLUE,
                ...
                "右键任何机器都会打开该机器界面；机器优先使用 EOU 电网，离网时才烧本地燃料。",
                "JEI 会显示 Earth Online 工业处理分类，并标出机器需要燃料。"));

        result.add(page("动力", "5. 动力和产物用途：不要只堆中间物", GOLD,
                "Earth Online Unit，简称 EOU，是第一版内置电力单位。先不强绑其他科技 mod，保证本体能独立跑起来。",
        ...
        result.add(page("后续", "25. 后续会怎么扩展？", MUTED,
        ...
        result.add(page("边界", "26. 哪些是本体，哪些是附属？", BLUE,
        ...
        result.add(page("土水", "27. 土壤和水文也是本体", GREEN,
        ...
        result.add(page("杂物", "28. 原版杂物也要有去处", GOLD,
    ...
    private static List<Page> createEnglishPages() {
        ...
        result.add(page("Machines", "4. Machine and multiblock basics", BLUE,
                ...
                "Machines prefer EOU grid power; local fuel is the off-grid fallback."));

        result.add(page("Power", "5. Power and useful outputs", GOLD,
                "Earth Online Unit, or EOU, is the first built-in power unit. It keeps the mod playable without guessing another tech mod's API.",
        ...
        result.add(page("Scope", "11. Core vs addons", BLUE,
                "Core Earth Online covers realistic Earth basics: geology, deposits, rocks, soil, hydrology, modern industry, power, infrastructure, handbook, and JEI routes.",
                ...
                "Sci-fi addon: advanced energy, space, AI, nanotech, and unrealistic automation.",
                "Keeping this split makes the core friendly to all players and modpacks while addons can be optional."));
        result.add(page("Soil", "12. Soil and hydrology are core", GREEN,
        ...
        result.add(page("Biomass", "13. Vanilla clutter gets routes", GOLD,
