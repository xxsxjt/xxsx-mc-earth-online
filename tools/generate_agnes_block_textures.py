#!/usr/bin/env python3
"""Generate polished Earth on Minecraft block and machine textures with Agnes.
...
BLOCKS = {
    ...
    "combustion_generator_front": ("modern compact combustion generator front face, clean black steel casing, safe orange combustion chamber window, subtle turbine grille, blue EOU connector light"),
    "battery_box_front": ("modern industrial battery box front face, clean dark battery enclosure, blue charge window, copper busbar details, safe insulated terminals"),
    "modern_machine_side": ("modern modular industrial machine side panel, satin steel composite panels, clean vents, bolts, narrow dark seams, contemporary factory equipment"),
    "modern_machine_top": ("modern modular industrial machine top panel, satin steel access hatches, clean ventilation slots, reinforced corner plates, contemporary factory equipment"),
    "power_machine_side": ("modern power equipment side panel, insulated dark steel shell, copper busbar strip, blue EOU status accent, clean industrial design"),
    "power_machine_top": ("modern power equipment top panel, insulated dark steel access cover, copper terminal plates, blue electrical accent, clean industrial design"),
    "thin_copper_power_cable": ("thin insulated copper power cable texture, orange copper strands under dark rubber insulation, small blue EOU tracer stripe, clean modern cable material"),
    "copper_power_cable": ("standard insulated copper power cable texture, orange copper conductor with black rubber insulation and blue EOU tracer stripe, clean modern cable material"),
    "heavy_copper_power_cable": ("heavy insulated copper power cable texture, thick bundled copper conductors, black industrial insulation, blue EOU tracer stripe, clean modern cable material"),
...
def prompt_for(block_id: str, descriptor: str) -> str:
    return (
        "Create one polished Minecraft mod block texture for Earth on Minecraft.\n"
        f"Block id: {block_id}\n"
